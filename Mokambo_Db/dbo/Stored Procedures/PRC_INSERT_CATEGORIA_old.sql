...
CREATE PROCEDURE [dbo].[PRC_INSERT_CATEGORIA_old]
@ID_PROGRESSIVO 	  INT,
...
AS
	...
	BEGIN TRY
		...
		--IF EXISTS(SELECT DESCRIZIONE_CATEGORIA  FROM CATEGORIA  WHERE @DESCRIZIONE   = @DESCRIZIONE )
	...
	--		SET @RISULTATO  = 'KO DESCRIZIONE PREESISTENTE'		
		...
		BEGIN
			...
			INSERT INTO CATEGORIA (ID_CATEGORIA  ,DESCRIZIONE_CATEGORIA  , STATUS ,VISUALIZZA ) 
			VALUES(@ID_PROGRESSIVO  ,@DESCRIZIONE , 'V','S')
